...
%getpfmraw - read color PFM image
...
%
% PURPOSE:
%         Reads color PFM (raw) images.
%
% ARGUMENTS: 
%         filename: A string containing the name of the image file to be read.
%
% RETURNS:
%         pic: The color image in an array.

% http://www.cs.unc.edu/~adyilie/comp256/PA2/Source/MatLab/getpfmraw.m
% modified to load color .pfm's  -yzli
% modified to handle file endianness correctly -drm
